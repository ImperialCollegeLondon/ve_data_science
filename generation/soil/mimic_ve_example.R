...
vardef <- list(
  ncvar_def("pH_values", "unitless", list(xdim, ydim)),
  ncvar_def("bulk_density_values", "kg m^-3", list(xdim, ydim)),
  ncvar_def("clay_fraction_values", "fraction", list(xdim, ydim)),
  ncvar_def("lmwc_values", "kg C m^-3", list(xdim, ydim)),
  ncvar_def("maom_values", "kg C m^-3", list(xdim, ydim)),
  ncvar_def("bacterial_C_values", "kg C m^-3", list(xdim, ydim)),
  ncvar_def("fungal_C_values", "kg C m^-3", list(xdim, ydim)),
  ncvar_def("pom_values", "kg C m^-3", list(xdim, ydim)),
  ncvar_def("necromass_values", "kg C m^-3", list(xdim, ydim)),
  ncvar_def("pom_enzyme_values", "kg C m^-3", list(xdim, ydim)),
  ncvar_def("maom_enzyme_values", "kg C m^-3", list(xdim, ydim)),
  ncvar_def("don_values", "kg N m^-3", list(xdim, ydim)),
  ncvar_def("particulate_n_values", "kg N m^-3", list(xdim, ydim)),
  ncvar_def("maom_n_values", "kg N m^-3", list(xdim, ydim)),
  ncvar_def("ammonium_values", "kg N m^-3", list(xdim, ydim)),
  ncvar_def("nitrate_values", "kg N m^-3", list(xdim, ydim)),
  ncvar_def("necromass_n_values", "kg N m^-3", list(xdim, ydim)),
  ncvar_def("dop_values", "kg P m^-3", list(xdim, ydim)),
  ncvar_def("particulate_p_values", "kg P m^-3", list(xdim, ydim)),
  ncvar_def("maom_p_values", "kg P m^-3", list(xdim, ydim)),
  ncvar_def("necromass_p_values", "kg P m^-3", list(xdim, ydim)),
  ncvar_def("primary_p_values", "kg P m^-3", list(xdim, ydim)),
  ncvar_def("secondary_p_values", "kg P m^-3", list(xdim, ydim)),
  ncvar_def("labile_p_values", "kg P m^-3", list(xdim, ydim))
)
