...
def generate_sobol_samples(
    ...
    Args:
        ...
        seed:
            Random seed used for reproducible Sobol sampling. If ``None``, the
            sampling is not explicitly seeded.

    Returns:
        Returns:
            A NumPy array containing Sobol parameter samples generated by SALib.
...
def generate_morris_samples(
    ...
    Args:
        ...
        seed:
            Random seed used for reproducible Morris sampling. If ``None``, the
            sampling is not explicitly seeded.
