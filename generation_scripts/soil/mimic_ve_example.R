#| ---
#| title: Convert dataframe to netCDF
#|
#| description: |
#|     The goal is to mimic an ecologist's workflow of converting their field
#      data to VE input
#|
#| VE_module: Soil, Litter and any other that operates the same way
#|
#| author:
#|   - name: Hao Ran Lai
#|
...
#|
#| output_files:
#|   - name: example_soil_data_mimic.nc
#|     path: generation/soil/
#|     description: |
#|       A netCDF file that should be the same as the soil example data file
#|       generated by ve_example
#|
...
#|
#| usage_notes: |
#|   Based on https://pjbartlein.github.io/REarthSysSci/netCDF.html
#| ---
