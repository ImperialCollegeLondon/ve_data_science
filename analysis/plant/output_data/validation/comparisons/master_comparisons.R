...
build_metadata_summary <- function(script_paths) {
  ...
  list(
    title = "master_comparisons_metadata",
    generated_by = "analysis/plant/output_data/validation/comparisons/master_comparisons.R",
...
write_metadata_summary <- function(metadata_summary) {
  output_path <- "../metadata/master_comparisons_metadata.yml"
