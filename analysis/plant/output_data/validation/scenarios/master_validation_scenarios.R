#| ---
#| title: master_validation_scenarios
#|
#| description: |
...
#|
#| output_files:
#|   - name: master_validation_scenarios_metadata.yml
...
#|       processing scripts listed in master_validation_scenarios.R.
#|
...
#|   data_library/master_validation_data_library.R workflow.
#| ---
...
build_metadata_summary <- function(script_paths) {
  ...
  list(
    title = "master_validation_scenarios_metadata",
    generated_by = "analysis/plant/output_data/validation/scenarios/master_validation_scenarios.R",
...
write_metadata_summary <- function(metadata_summary) {
  output_path <- "../metadata/master_validation_scenarios_metadata.yml"
