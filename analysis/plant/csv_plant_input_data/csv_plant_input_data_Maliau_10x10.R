...
plant_pft_definitions_Maliau_10x10 <- t_model_parameters
...
# m
plant_pft_definitions_Maliau_10x10$m <- 2
# n
plant_pft_definitions_Maliau_10x10$n <- 5
# f_g
plant_pft_definitions_Maliau_10x10$f_g <- 0.02
# gpp_topslice
plant_pft_definitions_Maliau_10x10$gpp_topslice <- 0.1
...
plant_pft_definitions_Maliau_10x10$p_foliage_for_reproductive_tissue <- 0.073545706
...
write.csv(
  plant_pft_definitions_Maliau_10x10,
  "../../../data/derived/plant/csv_plant_input_data/plant_pft_definitions_Maliau_10x10.csv",
  row.names = FALSE
)
