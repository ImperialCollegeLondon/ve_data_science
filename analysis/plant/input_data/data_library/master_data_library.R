...
#|   - path: analysis/plant/input_data/data_library/reproduction_maliau.R
#|   - path: analysis/plant/input_data/data_library/pft_cohort_data_maliau.R
#|
#| output_files:
...
scripts <- c(
  ...
  "subcanopy_maliau.R",
  "reproduction_maliau.R",
  "pft_cohort_data_maliau.R"
)
