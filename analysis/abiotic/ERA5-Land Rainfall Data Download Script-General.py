...
request = {
    ...
    "year": "<year>",  # Replace with your desired year, e.g., "2020"
    ...
    "data_format": "netcdf",
    "area": [N, W, S, E],  # specify your own bounding box coordinates (North, West, South, East)
}

# Download the dataset
output_filename = "ERA5_rainfall_<region>_<year>.nc" #specify your own <region> and <year> 
