...
def parse_args():
    """Parse the command-line arguments for a subJob run."""
    ...
    parser.add_argument(
        "pbs_array_index", type=int, help="PBS array job index (integer)."
    )
    parser.add_argument(
        "output_dir", type=Path, help="Directory where output should be written."
    )
