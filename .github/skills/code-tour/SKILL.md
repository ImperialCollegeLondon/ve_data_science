...
1. Build a mental model of the top 5–7 modules
1. For the requested persona, identify the **2–3 modules that matter most** and read those deeply
1. For modules you're not covering, mention them in the intro step as "out of scope for this tour"
1. Use `directory` steps for areas you mapped but didn't read — they orient without requiring full knowledge
...
1. Read the file
1. Find the exact line of the code you want to highlight
1. Understand it well enough to explain it to the target persona
...
1. **High-level map** (1–3 directory or uri steps) — major modules and how they relate.
   Not every folder — just what this persona needs to know.

1. **Core path** (file/line, selection, pattern, uri steps) — the specific code that matters.
   This is the heart of the tour. Read and narrate. Don't skim.

1. **Closing** (content) — what the reader now understands, what they can do next,
